export let users = [
	{
		...
		employees: {
			tableEmployees: [
				['1', 'Постоянная', 'Помощник',  'Никанорова Василиса Константиновна (Вася)', '27.03.2023', 'Активен' ],
			...
			employeesList: [
				{
					...
					tableEvents: [
						['1', 'Прошедшее', 'Вратарь', 'Битва на Неве — 2023 (спортивный турнир)', '23.03.2023 — 24.03.2023'],
					],
				...
				},
				{
					...
					tableEvents: [
						['1', 'Прошедшее', 'Вратарь', 'Битва на Неве — 2023 (спортивный турнир)', '23.03.2023 — 24.03.2023'],
						['2', 'Предстоящее', 'Вратарь', 'Судейский семинар ММА (учебное мероприятие)', '26.01.2024 — 26.01.2024'],
						['3', 'Предстоящее', 'Вратарь', 'Судейский семинар ММА (учебное мероприятие)', '29.01.2024 — 30.01.2024'],
					],
					events: [
						{
							id:'1',
