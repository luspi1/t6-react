export let users = [
	{
		...
		currentTariffInfo: {
			title: 'Базовый',
			cost: '20000',
			startPeriod: '03.03.2023',
			endPeriod: '03.03.2024',
			params: [
				'Первый параметр на одну строку',
				'Второй параметр, на две строки или вроде того',
				'Третий параметр на одну строку',
				'Четвертый параметр',
			],
		},

		tableTariffPayments: [
			['1', 'Ежегодная оплата тарифного плана', '23.03.2023 20:22', '20000', 'Картой'],
			['2', 'Оплата какой-то услуги или вроде...', '23.03.2023 20:22', '5000', 'Картой'],
			['3', 'Аренда входной группы № 4', '23.03.2023 20:22', '131400', 'Картой'],
		],
	},
]
